...
//         politics: '/data/governance_data.json',
//         ucdp: '/data/UCDP_data.json',
//         military: '/data/military_expenses_data.json',
//         armsExports: '/data/arms_exports_data.json',
//         armsImports: '/data/arms_import_data.json',
//         weaponSystems: '/data/weapon_system_Data.json',
//         weaponImports: '/data/weapon_import.json',
//     };
